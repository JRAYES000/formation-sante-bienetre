---
slug: micro-entreprise-estheticienne-demarches
title: "Créer une micro-entreprise en esthétique en 2026 : étapes, charges et pièges à éviter"
...
- Pas de comptabilité complexe (livre de recettes suffit)
- Charges sociales et fiscales proportionnelles au chiffre d'affaires : si vous ne gagnez rien, vous ne payez rien
- Gestion simplifiée des déclarations (mensuelle ou trimestrielle en ligne)
- Cumul possible avec un emploi salarié ou des allocations sous conditions

Ses limites :
- Seuils de chiffre d'affaires à ne pas dépasser (77 700 euros pour une activité de services en 2026)
- Pas de déduction des charges réelles (impossible de déduire le matériel, les produits, le loyer de votre studio)
- TVA non récupérable tant qu'on est sous le seuil de franchise (sauf si option TVA)
...
- Être titulaire d'un CAP Esthétique-Cosmétique-Parfumerie (ou équivalent reconnu)
- Ou justifier d'une expérience professionnelle de 3 ans dans le secteur sous la direction d'un diplômé
...
Explorez les formations disponibles sur [notre catalogue](/formations) et notamment les métiers de [l'esthétique soin corporel](/metier/esthetique-soin-corporel) pour choisir le bon diplôme.
...
Ce code regroupe :
- Les instituts de beauté et salons d'esthétique
- Les activités d'esthétique à domicile
- Les centres de manucurie et prothésie ongulaire
...
- La convention collective applicable (même si en micro-entreprise vous n'avez pas de salariés)
- Certaines cotisations professionnelles (cotisation CFP notamment)
...
- Justificatif de domicile de moins de 3 mois (si vous domiciliez la micro-entreprise à votre adresse personnelle)
...
- Votre forme juridique : Entreprise individuelle (EI)
- Votre activité principale : soins de beauté / esthétique
- Votre adresse professionnelle (domicile personnel possible)
- Votre régime fiscal souhaité : micro-BNC pour les esthéticiennes exerçant seules
...
- Mensuelle : déclaration et paiement avant le 31 du mois suivant
- Trimestrielle : déclaration et paiement avant le dernier jour du mois suivant le trimestre (30 avril, 31 juillet, 31 octobre, 31 janvier)
...
Consultez notre article sur les [aides Pôle emploi pour la formation beauté](/blog/aide-pole-emploi-formation-beaute) pour en savoir plus sur les dispositifs disponibles en période de transition.
...
La Contribution à la Formation Professionnelle (CFP) est incluse dans le taux de 22 % de cotisations. Elle vous donne droit à des heures de formation financées. Pour mobiliser ce droit, inscrivez-vous sur Mon Compte Formation (moncompteformation.gouv.fr) et vérifiez votre solde CPF. Consultez notre article sur [comment utiliser son CPF pour une formation beauté](/blog/cpf-comment-utiliser-formation-beaute).
...
Consultez notre article complet sur [l'ouverture d'un cabinet ou salon esthétique](/blog/salon-esthetique-local-commercial-installation) pour les questions de local, normes ERP, accessibilité PMR et matériel indispensable.

Pour les questions liées à l'ouverture d'un établissement complet, notre guide [ouvrir un institut de beauté](/blog/ouvrir-institut-beaute-formation) détaille les étapes et la formation requise.

---

## FAQ : micro-entreprise esthéticienne

**Faut-il un diplôme pour créer une micro-entreprise en esthétique ?**
Oui. La profession d'esthéticienne est réglementée. Pour exercer à titre indépendant, vous devez être titulaire d'un CAP esthétique ou équivalent, ou justifier de 3 ans d'expérience sous la direction d'un diplômé. Explorez les formations disponibles sur [notre catalogue](/formations).

**Peut-on créer une micro-entreprise en esthétique sans local ?**
Oui. Les activités à domicile (chez les clients) ou en location de salle ne nécessitent pas de local propre. Domiciliez alors la micro-entreprise à votre adresse personnelle.

**Quelles sont les obligations en termes de caisse enregistreuse ?**
Depuis 2018, les micro-entrepreneurs qui réalisent des ventes ou prestations à des particuliers doivent utiliser un logiciel de caisse certifié ou des tickets de caisse conformes. En pratique, des applications comme Sumup ou iZettle permettent d'émettre des reçus conformes facilement.

**La micro-entreprise en esthétique est-elle compatible avec le statut de demandeure d'emploi ?**
Oui, avec le dispositif ACRE (exonération partielle de cotisations la 1re année) et le dispositif ARE Création qui permet de cumuler allocations et revenus indépendants. Renseignez-vous auprès de France Travail avant de vous lancer.

**Peut-on vendre des produits cosmétiques en micro-entreprise ?**
Oui, la vente de produits cosmétiques est possible. Elle relève du régime BIC commercial, avec un seuil de CA différent (188 700 euros pour la vente de marchandises). Si vous mélangez prestations et vente de produits, vous pouvez avoir deux seuils distincts.

**Quelle mutuelle souscrire en micro-entreprise esthétique ?**
La couverture santé de base (remboursements Sécurité sociale) est assurée par l'URSSAF via vos cotisations. En revanche, il n'y a pas de mutuelle obligatoire en micro-entreprise (contrairement aux salariés). Souscrivez une mutuelle individuelle pour compléter vos remboursements.

**Dois-je m'inscrire à la Chambre des métiers ?**
Les esthéticiennes exercant une activité artisanale (prestation manuelle) doivent s'immatriculer au Répertoire des Métiers (tenu par les Chambres des métiers et de l'artisanat, CMA). Cette inscription est automatiquement déclenchée lors de votre création sur le Guichet unique si vous déclarez une activité artisanale.

**Combien coûte la création d'une micro-entreprise ?**
La création d'une micro-entreprise en France est entièrement gratuite depuis le passage au Guichet unique INPI.

**L'ACRE est-elle encore disponible en 2026 ?**
L'ACRE (Aide à la Création ou à la Reprise d'une Entreprise) offre une réduction de cotisations de 50 % pendant les 4 premiers trimestres d'activité. Elle est disponible pour les demandeurs d'emploi, bénéficiaires du RSA, et jeunes de moins de 26 ans notamment. Vérifiez votre éligibilité sur impots.gouv.fr ou le site de l'URSSAF.
...
- [Devenez esthéticienne indépendante](/blog/devenir-estheticienne-independante) : conseils pour bâtir votre clientèle
- [Ouvrir un salon esthétique avec local](/blog/salon-esthetique-local-commercial-installation) : normes, matériel et budget
- [Financement CPF](/financement-cpf) : comment financer votre formation avant de vous lancer
- [Règles CPF 2025-2026](/blog/financement-cpf-regles-2025-2026) : les dernières évolutions du financement formation
