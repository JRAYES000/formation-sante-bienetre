  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`shrink-0 inline-flex items-center justify-center gap-2 bg-primary text-white rounded-full hover:bg-primary-active transition-colors font-medium ${big ? "h-12 px-6" : "h-10 px-4"}`}
